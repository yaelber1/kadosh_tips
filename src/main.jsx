    ...
    <ThemeProvider theme={theme}>
      ...
      <Container maxWidth="sm" sx={{bgcolor: '#F5EDD9'}}>
        ...
        <Container maxWidth="sm">
          <h2 style={{width: '400px', margin: 'auto', marginBottom: '16px',display: 'flex', flexDirection: 'column', alignItems: 'center',fontFamily: 'Rubik, sans-serif', fontSize: '25px', fontWeight: 'bold'}}>חישוב טיפים יומיים בקלות</h2>
          <App></App>
        </Container>    
    </ThemeProvider>
